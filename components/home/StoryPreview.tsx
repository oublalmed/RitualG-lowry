        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          >
            <div
              ...
              style={{ background: 'linear-gradient(135deg, #2a1f18 0%, #C9A875 100%)' }}
            />
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <motion.p variants={fadeInRight} className="text-xs font-inter font-semibold uppercase tracking-[0.15em] text-[#C9A875] mb-4">
              Notre Histoire
            </motion.p>
            <motion.h2 variants={fadeInRight} className="text-3xl md:text-4xl lg:text-5xl font-playfair font-bold italic text-[#FAF6EF] leading-tight">
            ...
            <motion.div variants={fadeInRight} className="mt-8">
              <Link href="/a-propos" className="inline-flex items-center gap-2 font-inter font-semibold text-sm text-[#C9A875] hover:text-[#FAF6EF] transition-colors group">
