      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <motion.h2 variants={fadeInRight} className="text-3xl md:text-4xl font-playfair font-bold italic text-[#3D2B1F] leading-tight">
            ...
            <motion.p variants={fadeInRight} className="mt-4 text-sm font-inter text-[#3D2B1F]/70 leading-relaxed">
              ...
              les mots <em>Glow</em> (éclat, rayonnement) et <em>Glory</em> (fierté, grandeur, accomplissement).
            </motion.p>
            <motion.p variants={fadeInRight} className="mt-4 text-sm font-inter text-[#3D2B1F]/70 leading-relaxed">
