...
export default function LoginPage() {
  ...
  return (
    <div
      className="w-full max-w-md bg-[#F5EDE0] rounded-2xl border border-[#C9A875]/20 shadow-xl px-8 py-10"
    >
      <h1
      ...
      <div className="flex items-center gap-3 my-6">
        <div className="flex-1 h-px bg-[#C9A875]/20" />
        <span className="text-sm text-[#3D2B1F]/40 font-inter">ou</span>
        <div className="flex-1 h-px bg-[#C9A875]/20" />
      </div>
      ...
      <Button
        ...
        className="w-full border-[#C9A875]/30 text-[#3D2B1F] hover:bg-[#FAF6EF] font-inter flex items-center justify-center gap-3 py-3 rounded-lg"
      >
      ...
      <p className="text-center text-sm text-[#3D2B1F]/60 mt-6 font-inter">
        ...
        <Link href="/register" className="text-[#C9A875] hover:text-[#B8924B] font-medium transition-colors">
          Créer un compte →
        </Link>
      </p>
    </div>
